...
// Source: discordplayer/dcainterface.go
//
...
func (m *MockDiscordAudio) NewStream(source dca.OpusReader, vc discordplayer.DiscordVoiceConnection, done chan error) *dca.StreamingSession {
	m.ctrl.T.Helper()

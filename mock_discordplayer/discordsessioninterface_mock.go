...
// Source: discordplayer/discordsessioninterface.go
//
...
// Package mock_discordplayer is a generated GoMock package.
package mock_discordplayer
...
func (m *MockDiscordSession) ChannelVoiceJoin(gID, cID string, mute, deaf bool) (discordplayer.DiscordVoiceConnection, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChannelVoiceJoin", gID, cID, mute, deaf)
	ret0, _ := ret[0].(discordplayer.DiscordVoiceConnection)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
